...
#else
 // #define STACK_PROFILE_ID      HOME_CONTROLS  因为改变了最大子节点的个数和最大路由子节点的个数
  //                                                      ，所以必须改为指定网络的STACK_PROFILE_ID
...
// Maximum number in tables
  ...
  //#define NWK_MAX_DEVICE_LIST     20  // Maximum number of devices in the
   #define NWK_MAX_DEVICE_LIST     4                              // Assoc/Device list.
#endif
...
#define NWK_MAX_ROUTERS           2   //子节点里  路由器节点最多2个。
...
#define NWK_PAN_COORD_ADDR 0x0000    //协调器的网络地址定义为0x0000;
